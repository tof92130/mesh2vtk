...
message("\n>> FindSCOTCH: SCOTCH_DIR= $ENV{SCOTCH_DIR}")
...
message("   FindSCOTCH: SCOTCH_INCLUDE_DIRS= ${SCOTCH_INCLUDE_DIRS}")
...
message("   FindSCOTCH: SCOTCH_LIBRARY= ${SCOTCH_LIBRARY}")
...
message("   FindSCOTCH: SCOTCHERR_LIBRARY= ${SCOTCHERR_LIBRARY}")
...
message("   FindSCOTCH: PTSCOTCH_LIBRARY= ${PTSCOTCH_LIBRARY}")

# Check for ptscotchparmetis
find_library(PTSCOTCHPARMETIS_LIBRARY
  NAMES ptscotchparmetis
  HINTS ${SCOTCH_DIR}/lib $ENV{SCOTCH_DIR}/lib
  NO_DEFAULT_PATH
  DOC "The Pt-SCOTCHPARMETIS library"
  )
find_library(PTSCOTCHPARMETIS_LIBRARY
  NAMES ptscotchparmetis
  DOC "The Pt-SCOTCHPARMETIS library"
  )
message("   FindSCOTCH: PTSCOTCHPARMETIS_LIBRARY= ${PTSCOTCHPARMETIS_LIBRARY}")
...
#message("   FindSCOTCH: PTSCOTCH_LIBRARY         = ${PTSCOTCH_LIBRARY}")
#message("   FindSCOTCH: PTSCOTCHERR_LIBRARY      = ${PTSCOTCHERR_LIBRARY}")
#message("   FindSCOTCH: PTSCOTCHPARMETIS_LIBRARY = ${PTSCOTCHPARMETIS_LIBRARY}")
#message("   FindSCOTCH: SCOTCH_LIBRARY           = ${SCOTCH_LIBRARY}")
#message("   FindSCOTCH: SCOTCHERR_LIBRARY        = ${SCOTCHERR_LIBRARY}")

set(SCOTCH_LIBRARIES     ${PTSCOTCHPARMETIS_LIBRARY} ${PTSCOTCH_LIBRARY} ${PTSCOTCHERR_LIBRARY} ${SCOTCH_LIBRARY} ${SCOTCHERR_LIBRARY} CACHE STRING "SOCTCH parallel   libraries")
set(SCOTCH_SEQ_LIBRARIES                             ${SCOTCH_LIBRARY}   ${SCOTCHERR_LIBRARY}                                          CACHE STRING "SOCTCH sequential libraries")

#message("   FindSCOTCH: SCOTCH_LIBRARIES=    ${SCOTCH_LIBRARIES}")
...
message("   FindSCOTCH: SCOTCH_FOUND=        ${SCOTCH_FOUND}")
message("   FindSCOTCH: SCOTCH_INCLUDE_DIRS= ${SCOTCH_INCLUDE_DIRS}")
message("   FindSCOTCH: SCOTCH_LIBRARIES=    ${SCOTCH_LIBRARIES}")
message("   FindSCOTCH: SCOTCH_VERSION=      ${SCOTCH_VERSION}")
message("<< FindSCOTCH\n")